...
/// Without this class emojis have different sizes compared to fonts.
/// Because of this bug it bounces the screen if you replace one to another such as we have in the home screen.
/// For more details check this issue: https://github.com/flutter/flutter/issues/28894
class EmojiText extends StatelessWidget {
  ...
  List<TextSpan> generateTextSpans(String text) {
    ...
    final TextStyle boldStyle = style.copyWith(fontWeight: FontWeight.bold);
